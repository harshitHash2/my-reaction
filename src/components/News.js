...
export class News extends Component {
  ...
  handleprevClick= async ()=>{
    ...
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.this.props.country}&category=${this.props.category}&apiKey=b7d500003d5a41e188ee292eb014f5ea&page=${this.state.page-1}&this.props.pageSize=${this.props.pageSize}`;
  ...
  handlenextClick = async ()=> {
    ...
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=b7d500003d5a41e188ee292eb014f5ea&page=${this.state.page+1}&this.props.pageSize=${this.props.pageSize}`;
    this.setState({loading: true});
    let data= await fetch(url);
    let parseddata= await data.json();
    this.setState({
  ...
  async componentDidMount(){
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=b7d500003d5a41e188ee292eb014f5ea&page=1&pageSize=${this.props.pageSize}`;
    let data= await fetch(url);
    let parseddata= await data.json();
    this.setState({
      articles: parseddata.articles,
